class Constants {
  ...
  static const String charactersPath = "/character";
  static const String characterById = "/{id}";
  static const String characterByIds = "/{ids}";
  // Images
  ...
  // Characters
  static const int maxEpisodes = 4;
  static const int nInterestingCharacters = 3;
}
